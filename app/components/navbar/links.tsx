...
export function Links() {
  ...
  const { darkMode, toggleDarkMode } = useStyles();

  return (
    <nav
      className={`navbar navbar-expand-lg ${
        darkMode ? "bg-dark" : "bg-light"
      } row px-3 fw-semibold py-3 fs-5`}
    >
      <div
        className={`container-fluid border-bottom ${
          darkMode ? "dark-subtle" : "light-subtle"
        }`}
      >
        <NavLink href="/">
          <Image
        ...
        <button
          className={`justify-content-end fw-semibold mt-2 ${
            darkMode ? "bg-dark" : "bg-light"
        ...
        <label className={`${styles.themeswitch} me-3 my-3`}>
          <input
            type="checkbox"
          ...
          <div className={`${styles.themeswitchcontainer}`}>
            ...
            <div className={`${styles.themeswitchcirclecontainer}`}>
              <div className={`${styles.themeswitchsunmooncontainer}`}>
                ...
                <div className={`${styles.themeswitchsun}`}>
                  <div className={`${styles.themeswitchrays}`}></div>
                </div>
              </div>
            </div>
          </div>
